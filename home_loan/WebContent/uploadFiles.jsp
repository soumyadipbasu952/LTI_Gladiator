...
<form  class="modal-content animate" method="post" action="savefile" enctype="multipart/form-data"> 

<lable>Merge Aadhar/Voter,Pan Card and Upload in a single PDF</lable>
