...
<form method="post" action="/home_loan/addBusiness" >
   <label for="patAsPerLatestItr"><b>Pat_As_Per_Latest_ITR: </b></label>
          <input type="text" placeholder="Pat_As_Per_Latest_ITR: "  name="patAsPerLatestItr" required>


          <label for="depreciationLast3Avg"><b>Depriciation_In_Last_Three_Years</b></label>
          <input type="text" placeholder="Depriciation_In_Last_Three_Years" name="depreciationLast3Avg" required>
 ...
 <label for="existingEmi"><b>Existing EMI</b></label>
          <input type="text"  placeholder="Existing EMI" name="existingEmi" required>
          
    <label for="typeOfEmployment"><b>Type_Of_Employment</b></label>
          <input type="text" placeholder="Type_Of_Employment" value="Self Employed" name="typeOfEmployment" required>
